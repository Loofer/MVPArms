 ...
 * ==========================================================
 */
public class NoBarModel extends BaseModel<ServiceManager, CacheManager> implements NoBarContract.Model {
    private Gson mGson;
    private Application mApplication;

    public NoBarModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
